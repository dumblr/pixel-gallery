      ...
      <Wrapper>
        ...
        <Section>
          ...
          <ul>
            ...
            <li>add a piece of someone else's artwork to your own gallery</li>
          </ul>
        ...
        <Section>
          <h2>Why can't I use Chrome, Safari, or Firefox?</h2>
          <p>
            Pixel Gallery uses the <code>dat://</code> protocol. This is
            currently only supported in Beaker Browser, though other browsers
            are considering adding support for the protocol.
          </p>
        </Section>
        <Section>
